    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (currentUser?.organization_id) {
                try {
                    const campusesRes = await axios.get(`/api/organizations/${currentUser.organization_id}/campuses`);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input 
                                ...
                                onChange={handleChange}
                                className={`w-full px-4 py-3 rounded-xl border ${errors.password ? 'border-red-500' : 'border-slate-200'} focus:ring-2 focus:ring-indigo-500 outline-none bg-slate-50 font-medium`}
                                required={!isEdit}
                            />
